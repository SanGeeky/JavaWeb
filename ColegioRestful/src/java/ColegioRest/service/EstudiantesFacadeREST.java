...
import ColegioRest.Estudiantes;
...
public class EstudiantesFacadeREST extends AbstractFacade<Estudiantes> {
    ...
    @Path("{id}")
    @Consumes({"application/xml", "application/json"})
    public void edit(@PathParam("id") String id, Estudiantes entity) {
        super.edit(entity);
    }
    ...
    public Estudiantes find(@PathParam("id") String id) {
